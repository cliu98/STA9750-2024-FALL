...
if (!require("plotly")) install.packages("treemap")
```
...
ggplot(combined_ratings, aes(x = season, y = avg_rating, fill = season)) +
  ...
  labs(title = "Average Ratings of Happy Days",
       x = "Seasons",
       y = "Average Rating",
       caption = "Figure 3") +
  theme_minimal() +
...
genre_distribution_2010 <- genre_distribution_2010 |>
  pivot_longer(cols = c(`Unsuccessful Movies`, total_movies),
               names_to = "Type",
               values_to = "Count") |>
...
![Figure 8: Promotional Metropolis Remake Poster, generated by ChatGPT](mp02remakeposter.png)
