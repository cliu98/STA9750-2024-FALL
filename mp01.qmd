...
3.  In 2022, North Carolina State University via bus had the lowest expenses per trip with a ratio of 1.18.
...
4.  In 2022, the Altoona Metro Transit via demand rail had the highest total fares per trip with a ratio of 660.
...
5.  In 2022, the VIA Metropolitan Transit via vanpool had the lowest expenses per vehicle revenue mile with a ratio of 0.37.
...
6.  In 2022, the Chicago Water Taxi (Wendella) via Ferry had the highest total fares per vehicle revenue mile with a ratio of 237.
